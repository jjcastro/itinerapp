...
(function (ng) {
    ...
    mod.controller("recuerdoCtrl", ["$scope", "perfilService", function ($scope, svc) {
        ...
        //$scope.records = [];
            ...
            this.fetchRecords = function () {
             ...
             this.fetchRecordSelec = function () {
              
               return  svc.recuerdoSeleccionado().then(function(response)
               {
